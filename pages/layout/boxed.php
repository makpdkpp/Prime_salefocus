        ...
        <tbody id="companyTable">
          <?php while ($p = $products->fetch_assoc()): ?>
            <tr>
              <td><?= $p['Product'] ?></td>
              <td>
                <button class='btn btn-sm btn-info btn-edit' data-id='<?= $p['product_id'] ?>' data-name="<?= $p['Product'] ?>" data-toggle='modal' data-target='#editModal'>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">เพิ่มชื่อข้อมูลกลุ่มสินค้า</h4>
...
<script>
  $(document).on('click', '.btn-edit', function () {
    ...
    $('#edit_product').val($(this).data('name'));
  });
</script>
</body>
</html>
