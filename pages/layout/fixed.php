...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../layout/fixed.php"><i class="fa fa-circle-o"></i> เพิ่มข้อมูลอุตสาหกรรม</a></li>
  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container">
        <h2>เพิ่มข้อมูลอุตสาหกรรม</h2>
        <form action="add01_product.php" method="POST">
          <label for="Industry">อุตสาหกรรม :</label>
          <input type="text" name="Industry" id="Industry" maxlength="50" required>
          <input type="submit" value="บันทึกข้อมูล">
        </form>
      </div>

      <div class="container1">
        <h2>ข้อมูลอุตสาหกรรม</h2>
        <table>
          <thead>
            <tr>
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        <td>{$row['Industry']}</td>
                        <td class='actions'>
                          <a href='edit_fixed.php?Industry_id={$row['Industry_id']}'><i class='fa fa-pencil-square-o text-success'></i> Edit</a>
                          <a href='delete_fixed.php?Industry_id={$row['Industry_id']}' onclick=\"return confirm('คุณต้องการลบหรือไม่?')\">
