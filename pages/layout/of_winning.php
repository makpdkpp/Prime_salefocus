  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">ข้อมูลโอกาสการชนะ</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
          ...
          <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                  <button class='btn btn-sm btn-info btn-edit' data-id='<?= $row['priority_id'] ?>' data-name="<?= htmlspecialchars($row['priority'], ENT_QUOTES) ?>">
      ...
      <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <form id="editForm" action="priority_level1.php" method="POST">
