...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../layout/boxed.php"><i class="fa fa-circle-o"></i> เพิ่มข้อมูลกลุ่มสินค้า</a></li>
  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container">
        <h2>เพิ่มข้อมูลกลุ่มสินค้า</h2><br>
            ...
            if ($result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                echo "<tr>
                        <td>{$row['Product']}</td>
                        <td>
                          <a href='edit_boxed.php?product_id={$row['product_id']}'><i class='fa fa-pencil-square-o' style='color: #4CAF50;'></i> Edit</a> |
                          <a href='delete_boxed.php?product_id={$row['product_id']}' onclick=\"return confirm('คุณต้องการลบหรือไม่?')\">
