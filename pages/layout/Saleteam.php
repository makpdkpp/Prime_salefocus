      ...
      <li class="treeview active">
        ...
        <ul class="treeview-menu">
          <li><a href="../layout/top-nav.php"><i class="fas fa-building"></i> เพิ่มข้อมูลบริษัท</a></li>
            ...
            <li class="active"><a href="../layout/Saleteam.php"><i class="fas fa-users"></i> ทีมขาย</a></li>
          ...
          <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
              <tr>
                <td><?= $row['team'] ?></td>
                <td>
                  <button class='btn btn-sm btn-info btn-edit' data-id='<?= $row['team_id'] ?>' data-name="<?= htmlspecialchars($row['team']) ?>" data-toggle='modal' data-target='#editModal'>
