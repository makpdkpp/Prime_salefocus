...
if (isset($_POST['submit'])) {
    ...
    // Update the record
    $update_sql = "UPDATE position SET Job_position='$Job_position' WHERE id=$id";
...
<body>
    ...
    <section class="content">
          ...
          <div class="container">
            ...
            <form method="POST">
              <label>ตำแหน่ง : </label>
              <input type="text" id="Job_position" name="Job_position" value="<?php echo $row['Job_position']; ?>" required>
                  <input type="submit" name="submit" value="Update">
                  <!-- ปุ่มย้อนกลับ -->
                   <button type="button" onclick="window.location.href='position_u.php';">
                    ย้อนกลับ
                </button>
              </form>
          </div>
