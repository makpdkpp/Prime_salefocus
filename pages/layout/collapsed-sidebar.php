        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-is-opening menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a href="../layout/collapsed-sidebar.php" class="nav-link active"><i class="fas fa-tasks nav-icon"></i><p>ขั้นตอนการขาย</p></a></li>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">ข้อมูลขั้นตอนการขาย</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
          ...
          <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                  <button class='btn btn-sm btn-info btn-edit' data-id='<?= $row['level_id'] ?>' data-name="<?= htmlspecialchars($row['level'], ENT_QUOTES) ?>">
      ...
      <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <form id="editForm" action="add_step.php" method="POST">
