                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open"> <a href="#" class="nav-link active">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="home_user_01.php" class="nav-link active"> <i class="far fa-circle nav-icon"></i>
                                    <p>Dashboard (ตาราง)</p>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="User/adduser01.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Sales Dashboard (<?= $nname ?: 'Sales' ?>)</h1>
                    </div>
                </div>
            </div></section>
                                ...
                                <table id="salesTable" class="table table-bordered table-hover">
                                     <thead>
                                        <tr>
                                          ...
                                          <th>วันที่เริ่ม</th><th>วันยื่น Bidding</th><th>วันเซ็นสัญญา</th><th>ขั้นตอน</th><th>หมายเหตุ</th><th>Action</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                      <?php
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="User/edit_adduser.php?id=<?= $r['transac_id']?>" class="btn btn-sm btn-info">
