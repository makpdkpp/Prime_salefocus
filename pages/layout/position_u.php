...
$conn = connectDb();
$sql = "SELECT product_id, Product FROM product_group";
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../layout/position_u.php"><i class="fa fa-circle-o"></i> ตำแหน่ง</a></li>
    ...
    <section class="content">
      <div class="container">
        ...
        <form action="add_position.php" method="POST">
          <label for="Job_position">ชื่อตำแหน่ง :</label>
          <input type="text" id="Job_position" name="Job_position" maxlength="50" required>
      ...
      <div class="container1">
        ...
        <table>
          ...
          <tbody>
            <?php
            $sql = "SELECT id, Job_position FROM position";
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td class='actions'>
                          <a href='edit_position_u.php?id={$row['id']}'><i class='fa fa-pencil text-success'></i> Edit</a>
                          <a href='delete_position.php?id={$row['id']}' onclick=\"return confirm('คุณต้องการลบหรือไม่?')\">
