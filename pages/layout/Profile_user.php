...
$conn = connectDb();
$sql = "SELECT 	email, nname,surename FROM user";
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../layout/Profile_user.php"><i class="fa fa-circle-o"></i> รายละเอียดผู้ใช้งาน</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <section class="content">
    <div class="container1">
      ...
      <table>
        ...
        <tbody>
          <?php
          // ดึงเฉพาะผู้ใช้งานที่มี role_id = 2
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              echo "<tr>
                      ...
                      <td>{$row['email']}</td>
                      <td>
                        <a href='delete_Pro.php?user_id={$row['user_id']}' onclick=\"return confirm('คุณต้องการลบหรือไม่?')\">
                          <i class='fa fa-trash' style='color: #f44336;'></i> ลบ
                        </a>
                      </td>
                    </tr>";
            }
