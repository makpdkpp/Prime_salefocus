...
$conn = connectDb();
$sql = "SELECT level_id , level FROM step";
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../layout/collapsed-sidebar.php"><i class="fa fa-circle-o"></i> ขั้นตอนการขาย</a></li>
  ...
  <div class="content-wrapper">
    <section class="content">
      ...
      <div class="container">
        <h2>เพิ่มขั้นตอนการขาย</h2>
        <form action="add_step.php" method="POST">
          <label for="level">ขั้นตอน :</label>
          <input type="text" id="level" name="level" maxlength="50" required>
          <input type="submit" value="บันทึกข้อมูล">
        </form>
      </div>

      <div class="container1">
        <h2>ข้อมูลขั้นตอนการขาย</h2>
        <table>
          <thead>
            <tr>
              <th>ขั้นตอน</th>
            ...
            if ($result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                echo "<tr>
                        <td>{$row['level']}</td>
                        <td>
                          <a href='edit_collapsed-sidebar.php?level_id={$row['level_id']}'><i class='fa fa-pencil-square-o' style='color: #4CAF50;'></i> Edit</a> |
                          <a href='delete_side.php?level_id={$row['level_id']}' onclick=\"return confirm('คุณต้องการลบหรือไม่?')\">
